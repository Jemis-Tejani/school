...
export interface ApiDivisionDivision extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    division_name: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPrincipalPrincipal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    principal_email: Schema.Attribute.Email & Schema.Attribute.Required;
...
export interface ApiStandardStandard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    standard_name: Schema.Attribute.String & Schema.Attribute.Required;
    students: Schema.Attribute.Relation<'oneToMany', 'api::student.student'>;
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    student_name: Schema.Attribute.String & Schema.Attribute.Required;
    student_roll_number: Schema.Attribute.Integer & Schema.Attribute.Required;
    subjects: Schema.Attribute.Relation<'manyToMany', 'api::subject.subject'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTeacherTeacher extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    teacher_email: Schema.Attribute.Email & Schema.Attribute.Required;
    teacher_name: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_permissions_user: Schema.Attribute.Relation<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    principal: Schema.Attribute.Relation<
      'oneToOne',
      'api::principal.principal'
    >;
